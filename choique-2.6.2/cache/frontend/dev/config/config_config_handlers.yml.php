...
$this->handlers['modules/*/config/view.yml'] = new choiqueViewConfigHandler();
...
$this->handlers['modules/*/config/search.yml'] = new sfLuceneModuleConfigHandler();
$this->handlers['modules/*/config/search.yml']->initialize();
$this->handlers['config/search.yml'] = new sfLuceneProjectConfigHandler();
$this->handlers['config/search.yml']->initialize();
$this->handlers['config/choique.yml'] = new choiqueConfigHandler();
$this->handlers['config/choique.yml']->initialize();
$this->handlers['flavors/*/config/images.yml'] = new choiqueImagesConfigHandler();
$this->handlers['flavors/*/config/images.yml']->initialize();
