...
abstract class BaseArticleTag extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArticleTagPeer::ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticleTagPeer::ID)) $criteria->add(ArticleTagPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArticleTagPeer::ID, $this->id);
