...
jQuery(document).ready(function() {
	...
	var conditionalDescription = divFilter + ' p.conditionally-description';
        var conditionalSummary = divFilter + ' p.conditional-summary';
	var description = divFilter +' p.description-ds';
	...
	var conditionalLimit = conditionalDescription +' span.conditionally-limit';
	var checkLimit = conditionalDescription +' span.limit';

	var filters = new Array ( {selector:description, conditional:conditionalDescription } ,
                               {selector:description, conditional:conditionalSummary } ,
