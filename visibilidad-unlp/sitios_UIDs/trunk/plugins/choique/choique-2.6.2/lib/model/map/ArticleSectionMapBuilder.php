...
class ArticleSectionMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ArticleSectionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('article_section');
		$tMap->setPhpName('ArticleSection');
