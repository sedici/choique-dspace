...
abstract class BaseDocumentPeer {
	...
	const UPLOADED_BY = 'document.UPLOADED_BY';
	...
	const UPDATED_BY = 'document.UPDATED_BY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Title', 'Uri', 'UploadedBy', 'CreatedAt', 'UpdatedAt', 'UpdatedBy', ),
		BasePeer::TYPE_COLNAME => array (DocumentPeer::ID, DocumentPeer::NAME, DocumentPeer::TITLE, DocumentPeer::URI, DocumentPeer::UPLOADED_BY, DocumentPeer::CREATED_AT, DocumentPeer::UPDATED_AT, DocumentPeer::UPDATED_BY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'title', 'uri', 'uploaded_by', 'created_at', 'updated_at', 'updated_by', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Title' => 2, 'Uri' => 3, 'UploadedBy' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'UpdatedBy' => 7, ),
		BasePeer::TYPE_COLNAME => array (DocumentPeer::ID => 0, DocumentPeer::NAME => 1, DocumentPeer::TITLE => 2, DocumentPeer::URI => 3, DocumentPeer::UPLOADED_BY => 4, DocumentPeer::CREATED_AT => 5, DocumentPeer::UPDATED_AT => 6, DocumentPeer::UPDATED_BY => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'title' => 2, 'uri' => 3, 'uploaded_by' => 4, 'created_at' => 5, 'updated_at' => 6, 'updated_by' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DocumentPeer::URI);

		$criteria->addSelectColumn(DocumentPeer::UPLOADED_BY);
    ...
    foreach (sfMixer::getCallables('BaseDocumentPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
	...
	public static function doCountJoinsfGuardUserRelatedByUploadedBy(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(DocumentPeer::UPLOADED_BY, sfGuardUserPeer::ID);
	...
	public static function doCountJoinsfGuardUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(DocumentPeer::UPDATED_BY, sfGuardUserPeer::ID);
	...
	public static function doSelectJoinsfGuardUserRelatedByUploadedBy(Criteria $c, $con = null)
	{
		...
		$c->addJoin(DocumentPeer::UPLOADED_BY, sfGuardUserPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getsfGuardUserRelatedByUploadedBy(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addDocumentRelatedByUploadedBy($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initDocumentsRelatedByUploadedBy();
				$obj2->addDocumentRelatedByUploadedBy($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinsfGuardUserRelatedByUpdatedBy(Criteria $c, $con = null)
	{
		...
		$c->addJoin(DocumentPeer::UPDATED_BY, sfGuardUserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getsfGuardUserRelatedByUpdatedBy(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addDocumentRelatedByUpdatedBy($obj1); 					break;
				}
			}
			if ($newObject) {
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				$temp_obj3 = $temp_obj1->getsfGuardUserRelatedByUpdatedBy(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addDocumentRelatedByUpdatedBy($obj1); 					break;
				}
			}

			if ($newObject) {
				$obj3->initDocumentsRelatedByUpdatedBy();
				$obj3->addDocumentRelatedByUpdatedBy($obj1);
			}
